...
TOKEN = '7441757961:AAGh6NXjHSWvZfR2t1TJqaIdQbFD-pasUkc'
...
FORWARD_CHANNEL_ID = -1002230727595
CHANNEL_ID = -1002230727595
error_channel_id = -1002230727595
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        if user_data:
            ...
            response = "*No account information found. Please contact @GOD_SUJAL.*"
        ...
        bot.reply_to(message, "*DM ~ @GOD_SUJAL*", parse_mode='Markdown')
